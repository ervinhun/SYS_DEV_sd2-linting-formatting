...
const skillIssue = {
  meta: {
    ...
    docs: {
      description:
        "Humorous meta-rule that scores a file for common rookie mistakes (‘skill issue’ meter).",
      recommended: false,
    },
    fixable: "code",
    schema: [
    ...
    messages: {
      ...
      console:
        "Skill issue: stray console. Consider removing or gating with env.",
      tsIgnore: "Skill issue: '@ts-ignore' found. Prefer proper typing.",
      any: "Skill issue: 'any' type detected. Be explicit.",
      emptyDeps:
        "Skill issue: useEffect has empty deps []. Are you sure? Add deps or justify.",
